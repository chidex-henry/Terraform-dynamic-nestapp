...
sudo aws s3 sync s3://chidex-nest-app-web-files /var/www/html
...
sudo aws s3 cp s3://chidex-app-service-provider-files/nest-AppServiceProvider.php /var/www/html/app/Providers/AppServiceProvider.php
